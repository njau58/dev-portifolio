...
const Menu = ({toggle,setToggle}:Props) => {
  return (
    ...
    <div className={`${toggle?'hidden':"md:hidden h-screen flex w-full   fixed z-50 top-0   bg-white flex-col font-semibold text-gray-700 rounded-sm pb-8 items-start px-8"}`}>
    <div
