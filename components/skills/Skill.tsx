...
const Skill = ({ skill, description, icon }: Props) => {
  return (
    <div className="flex flex-col mx-4 space-y-4 items-center justify-center rounded-3xl bg-white shadow-xl py-12 px-4 hover:bg-[#5258fb] hover:bg-opacity-5 cursor-pointer ">
