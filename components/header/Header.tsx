  ...
  return (
    <>
      <div
        className={`${
          shadow
            ? "shadow-lg h-20 ease-in-out delay-75  backdrop-blur-xl bg-white/30 top-0 flex flex-row justify-between items-center z-40  mx-auto  fixed shadow- w-full md:px-32 px-8 "
